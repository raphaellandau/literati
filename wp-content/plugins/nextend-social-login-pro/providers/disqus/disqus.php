...
class NextendSocialPROProviderDisqus extends NextendSocialProvider {
    ...
    public function getClient() {
        if ($this->client === null) {
            ...
            $this->client->setClientId($this->settings->get('api_key'));
            $this->client->setClientSecret($this->settings->get('api_secret'));
