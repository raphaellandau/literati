...
You can track **page visits**, **duration of the visit**, and you can even setup **event triggers** too (ie. click of a button, PDF download, mailto links and more).
...
* **[Premium]** Time tracking: see the duration of user visits in the activity logs
* **[Premium]** Event tracking: setup event triggers for various actions that users take on your site (ie. click on a specific button, PDF download, mailto links and more)
...
Absolutely not, the plugin is well optimized and does not cause any performace issues. 
